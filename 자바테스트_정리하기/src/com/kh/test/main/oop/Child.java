...
//메서드
	// 생성자 기본 CTRL SPACE 이긴 하지만 con st ru ctor 표시가 있는지 확인후 엔터
	public Child() {
	...
	public Child(int 자식변수) {
		...
		//super(); 하나의 자식 생성자에서 super를 두번 부르는건 불가능
		this.자식변수 = 자식변수;
	 ...
	 * 자식변수) { //super(부모변수); //부모변수에 어떻게 받아서 가져가겠다 라는 것이 없기 때문에 뜨는 에러 //부모변수에도 기본
	 * 생성자를 넣어서 작성 this.자식변수 = 자식변수; }
	 */
	public void 자식메서드() {
		super.부모메서드();
