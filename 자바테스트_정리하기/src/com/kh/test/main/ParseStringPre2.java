...
public class ParseStringPre2 {
	public static void main(String[] args) {
		...
		System.out.println("하이픈에서 제거된 핸드폰 번호 :"+하이픈제거);
		
		//주민번호에서 하이픈 제거
		String id = "230304-1234567";
		String 주민번호 = id.replace("-","");
		System.out.println("하이픈에서 제거된 주민번호 : "+주민번호);
...
//		String id2 = "2  4  0  1  0  1-  3  4  5  6789";
		...
		char 성별번호 = 주민번호2.charAt(6); //하이픈이 제거되어서 7이 아니라 6
		...
		boolean is주민 = 
				// [0-9]가 숫자 임
				(주민번호4.length() == 14) && //1.주민등록번호가 - 포함해서 14자리가 맞는지 확인
				(주민번호4.charAt(6) == '-')&&//2.주민등록번호 생년월일 작성후 -들어가있는지지
				// 0~5
